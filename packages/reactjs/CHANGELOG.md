...
- **Workspace Dependencies**: Bump version to 2.6.0 to align with `@bemedev/app`
  2.6.0 release.
...
- **`JSDoc`**: Comprehensive JSDoc type-linking standardisation across hooks and
  options.
