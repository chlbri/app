 ...
 *
 * @returns Valibot schema for validating a machine node configuration of type {@linkcode NodeConfig2}.
 *
 * @see {@linkcode CommonNodeConfigEntries}, {@linkcode NodeConfig_Schema}, {@linkcode recordV}, {@linkcode checkNodeType}
 */
