import { type ActivityConfig, type NodeConfig } from '~types';
...
export { isAtomic, isCompound, isParallel };
...
checkActivity.orUndefined = (value: unknown): boolean => {
  if (value === undefined) return true;
  return checkActivity(value);
};
